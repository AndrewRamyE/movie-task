...
const form = useForm({
    ...
    description: props.movie.data.description,
    rate: props.movie.data.rate,
    image: null,
    category_id: props.movie.data.category_id,
});

const submit = () => {
    form.patch(route('movie.update',props.movie.data.id), {
        onFinish: () => form.reset(),
    },{
        forceFormData: true,
    });
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-24">
                    ...
                    <form @submit.prevent="submit" enctype="multipart/form-data">
                        ...
                        <div>
                            <img :src="movie.data.image" style="max-height:100px;">
